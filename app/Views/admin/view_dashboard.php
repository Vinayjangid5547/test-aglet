...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-layout="vertical" data-pc-direction="ltr" data-pc-theme_contrast="" data-pc-theme="light">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid mt-3">
                                <button class="btn btn-primary d-flex align-items-center justify-content-center"><i class="ti ti-plus"></i> Add task</button>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="mt-3 d-grid">
                                        <button class="btn btn-primary d-flex align-items-center justify-content-center"><i class="ti ti-plus"></i> Add project</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4">
                                <div class="user-group able-user-group">
                                    <img src="<?php echo ASSETS_PATH; ?>images/admin/user/avatar-1.jpg" alt="user-image" class="avtar" />
                                    <img src="<?php echo ASSETS_PATH; ?>images/admin/user/avatar-3.jpg" alt="user-image" class="avtar" />
                                    <img src="<?php echo ASSETS_PATH; ?>images/admin/user/avatar-4.jpg" alt="user-image" class="avtar" />
                                    <img src="<?php echo ASSETS_PATH; ?>images/admin/user/avatar-5.jpg" alt="user-image" class="avtar" />
                    ...
                    <div class="card">
                            ...
                            <div
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <div class="avtar avtar-s border bg-light-primary" data-bs-toggle="tooltip" data-bs-title="143 Posts"><span>MD</span>
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row g-1">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <div class="avtar avtar-s border bg-light-warning" data-bs-toggle="tooltip" data-bs-title="143 Posts"><span>OC</span>
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row g-1">
                        ...
                        <div class="card-footer">
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <div class="d-grid">
                                        <button class="btn btn-outline-secondary d-grid"><span class="text-truncate w-100">View all Transaction History</span></button>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="d-grid">
    ...
    <script src="<?php echo ASSETS_PATH; ?>js/admin/pages/dashboard-default.js"></script>
