            ...
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item header-user-profile">
                    <a
                        ...
                        aria-expanded="false">
                        <img src="<?php echo ASSETS_PATH; ?>images/admin/user/avatar-2.jpg" alt="user-image" class="user-avtar" />
                    </a>
                        ...
                        <div class="dropdown-body">
                            <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
                                <div class="d-flex mb-1">
                                    <div class="flex-shrink-0">
                                        <img src="<?php echo ASSETS_PATH; ?>images/admin/user/avatar-2.jpg" alt="user-image" class="user-avtar wid-35" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                ...
                                <div
                                    ...
                                    style="background-image: url(<?php echo ASSETS_PATH; ?>images/admin/layout/img-profile-card.jpg)">
                                    <div class="card-body">
                                        <div class="user-group">
                                            <img src="<?php echo ASSETS_PATH; ?>images/admin/user/avatar-1.jpg" alt="user-image" class="avtar" />
                                            <img src="<?php echo ASSETS_PATH; ?>images/admin/user/avatar-2.jpg" alt="user-image" class="avtar" />
